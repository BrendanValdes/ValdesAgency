...
This project is indexed by GitNexus as **ValdesAgency** (3645 symbols, 5176 relationships, 175 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/ValdesAgency/context` | Codebase overview, check index freshness |
| `gitnexus://repo/ValdesAgency/clusters` | All functional areas |
| `gitnexus://repo/ValdesAgency/processes` | All execution flows |
| `gitnexus://repo/ValdesAgency/process/{name}` | Step-by-step execution trace |
